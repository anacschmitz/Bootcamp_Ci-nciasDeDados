...
##Sctipts para recuperação de dados através do SElECT, com filtro WHERE e o JOIN:
...
##Selecionar os produtos vendidos por um vendedor externo específico 
##(por exemplo, vendedor com ID 1) da tabela "produtos_vendedores_externos":
...
##Selecionar todos os pedidos em andamento (status "Em andamento") 
##da tabela "pedido" com informações de entrega associadas:
...
##Calcular o valor total de um pedido com base no preço do produto e na quantidade, assumindo que, 
## o valor do produto será buscado na tabela produtos através do join:
